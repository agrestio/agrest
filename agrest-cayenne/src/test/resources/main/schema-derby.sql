...
CREATE TABLE "e3" ("e2_id" INTEGER , "e5_id" INTEGER , "id_" INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 2000, INCREMENT BY 1), "name" VARCHAR (200), "phone_number" VARCHAR (12), PRIMARY KEY ("id_"))
;
...
CREATE SEQUENCE "PK_E29" AS BIGINT START WITH 200 INCREMENT BY 20 NO MAXVALUE NO CYCLE
;
