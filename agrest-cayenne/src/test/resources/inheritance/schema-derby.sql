...
CREATE TABLE "ie1" ("a0" VARCHAR (100), "a1" VARCHAR (100), "a2" VARCHAR (100), "e2_id" INTEGER , "id" INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY, "type" INTEGER  NOT NULL, PRIMARY KEY ("id"))
;
