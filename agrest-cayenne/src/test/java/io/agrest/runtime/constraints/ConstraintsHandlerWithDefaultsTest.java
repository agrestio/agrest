...
public class ConstraintsHandlerWithDefaultsTest extends TestWithCayenneMapping {
	...
	private AgPersistentEntity<E1, ObjEntity> age1;
	private AgPersistentEntity<E2, ObjEntity> age2;
	...
	public void testConstrainResponse_PerRequest() {
		...
		Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).attributes(E1.DESCRIPTION.getName());

		ResourceEntity<E1, Object> te1 = new ResourceEntity<>(age1);
	...
	public void testConstrainResponse_None() {
		...
		ResourceEntity<E2, Object> te1 = new ResourceEntity<>(age2);
