...
public class ConstraintsHandlerTest {
    ...
    public void testApply_ResourceEntity_NoTargetRel() {
        ...
        Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).attributes("a", "b");

        ResourceEntity<E1, Object> te1 = new ResourceEntity<>(age0);
        appendAttribute(te1, "c");
        appendAttribute(te1, "b");

        ResourceEntity<?, ?> te11 = new ResourceEntity<>(age2);
    ...
    public void testApply_ResourceEntity_TargetRel() {
        ...
        ResourceEntity<?, ?> te11 = new ResourceEntity<>(age1);
        appendAttribute(te11, "m");
        appendAttribute(te11, "z");
        te1.getChildren().put("r1", te11);

        ResourceEntity<?, ?> te21 = new ResourceEntity<>(age4);
    ...
    public void testMerge_ResourceEntity_Id() {
        ...
        Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).excludeId();
        Constraint<E1, Object> tc2 = Constraint.excludeAll(E1.class).includeId();
        ...
        ResourceEntity<E1, Object> te3 = new ResourceEntity<>(age0);
        te3.excludeId();
    ...
    public void testMerge_MapBy() {
        ...
        Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).path("r1",
                Constraint.excludeAll(E2.class).attribute("a"));

        ResourceEntity<E1, Expression> te1MapByTarget = new ResourceEntity<>(age0);
        appendAttribute(te1MapByTarget, "b");

        ResourceEntity<E2, Expression> te1MapBy = new ResourceEntity<>(age1);
        ...
        ResourceEntity<E2, Expression> te2MapByTarget = new ResourceEntity<>(age1);
        appendAttribute(te2MapByTarget, "a");

        ResourceEntity<E1, Expression> te2MapBy = new ResourceEntity<>(age0);
    ...
    public void testMerge_MapById_Exclude() {
        ...
        Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).path("r1", Constraint.excludeAll(E2.class).excludeId());
    ...
    public void testMerge_MapById_Include() {
        ...
        Constraint<E1, Object> tc1 = Constraint.excludeAll(E1.class).path("r1", Constraint.excludeAll(E2.class).includeId());

        ResourceEntity<E2, Expression> te1MapByTarget = new ResourceEntity<>(age1);
        te1MapByTarget.includeId();

        ResourceEntity<E1, Expression> te1MapBy = new ResourceEntity<>(age0);
        te1MapBy.getChildren().put("r1", te1MapByTarget);
