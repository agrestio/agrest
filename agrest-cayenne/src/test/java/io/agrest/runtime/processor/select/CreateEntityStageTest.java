...
public class CreateEntityStageTest extends TestWithCayenneMapping {
	...
	public void setUp() {
        ...
        IAgExpMerger expMerger = new CayenneExpMerger(new ExpressionPostProcessor(pathCache));
	...
	public void testSelectRequest_CayenneExp() {
		...
		SelectContext<E2, Expression> context = new SelectContext<>(E2.class);
		...
		ResourceEntity<E2, Expression> resourceEntity = context.getEntity();
