...
public class CayenneAssembleQueryStageTest extends TestWithCayenneMapping {
	...
	@Before
	public void before() {
		//CayenneAssembleQueryStage is abstract
		this.makeQueryStage = new CayenneFetchDataStage(mockCayennePersister, orderingConverter);
	}
	...
	public void testBuildQuery_Ordering() {
		...
		ResourceEntity<E1, Expression> resourceEntity = getResourceEntity(E1.class);
		...
		SelectContext<E1, Expression> context = new SelectContext<E1, Expression>(E1.class);
//		context.setSelect(query);
	...
	public void testBuildQuery_Prefetches() {
		...
		ResourceEntity<E2, Expression> resultFilter = getResourceEntity(E2.class);
		AgRelationship incoming = resultFilter.getAgEntity().getRelationship(E2.E3S.getName());
		@SuppressWarnings("unchecked")
        AgPersistentEntity<E3, Expression> target = Mockito.mock(AgPersistentEntity.class);
		resultFilter.getChildren().put(E2.E3S.getName(), new ResourceEntity<E3, Expression>(target, incoming));

		SelectContext<E2, Expression> context = new SelectContext<E2, Expression>(E2.class);
...
//		context.setSelect(query);
	...
	public void testBuildQuery_Pagination() {
		...
		ResourceEntity<E1, Expression> resourceEntity = new ResourceEntity<>(getAgEntity(E1.class));
		resourceEntity.setFetchLimit(10);
		resourceEntity.setFetchOffset(0);

		SelectContext<E1, Expression> c = new SelectContext<E1, Expression>(E1.class);
	...
	public void testBuildQuery_Qualifier() {
		...
		SelectContext<E1, Expression> c1 = new SelectContext<>(E1.class);
...
//		c2.setSelect(query2);
	...
	public void testById() {
		...
		SelectContext<E1, Expression> c = new SelectContext<>(E1.class);
		c.setId(1);
