...
public class DefaultUpdateBuilderTest {
    ...
    private <T, E> DefaultUpdateBuilder<T, E> createBuilder(Class<T> type) {
        ...
        return new DefaultUpdateBuilder<T, E>(context, processorFactory);
    }
    ...
    public void testStage_FunctionTypes() {
        ...
        createBuilder(E2.class)
                ...
                .stage(UpdateStage.PARSE_REQUEST, (UpdateContext<E2, Object> s) -> {
                })
    ...
    public void testTerminalStage_FunctionTypes() {
        ...
        createBuilder(E2.class)
                ...
                .terminalStage(UpdateStage.PARSE_REQUEST, (UpdateContext<E2, Object> s) -> {
                })
    ...
    public void testRoutingStage_FunctionTypes() {
        ...
        createBuilder(E2.class)
                ...
                .routingStage(UpdateStage.PARSE_REQUEST, (UpdateContext<E2, Object> s) -> ProcessorOutcome.CONTINUE)
    ...
    private <T, E> void doSomething1(UpdateContext<T, E> c) {
    }

    private void doSomething2(UpdateContext<DataObject, Object> c) {
    ...
    private void doSomething3(UpdateContext<Object, Object> c) {
        c.setObjects(new ArrayList<>());
        c.setObjects(new ArrayList<E2>());
    }

    private void doSomething4(UpdateContext<E2, Object> c) {
        c.setObjects(new ArrayList<>());
        c.setObjects(new ArrayList<E2>());
    }
    ...
    private <T, E> ProcessorOutcome doSomethingAndReturn1(UpdateContext<T, E> c) {
        return ProcessorOutcome.CONTINUE;
    }

    private ProcessorOutcome doSomethingAndReturn2(UpdateContext<DataObject, Object> c) {
        c.setObjects(new ArrayList<>());
        c.setObjects(new ArrayList<E2>());
        return ProcessorOutcome.CONTINUE;
    }

    private ProcessorOutcome doSomethingAndReturn3(UpdateContext<Object, Object> c) {
        c.setObjects(new ArrayList<>());
        c.setObjects(new ArrayList<E2>());
        return ProcessorOutcome.CONTINUE;
    }

    private ProcessorOutcome doSomethingAndReturn4(UpdateContext<E2, Object> c) {
        c.setObjects(new ArrayList<>());
        c.setObjects(new ArrayList<E2>());
        return ProcessorOutcome.CONTINUE;
    }
