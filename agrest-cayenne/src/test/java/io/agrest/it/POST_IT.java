...
public class POST_IT extends JerseyTestOnDerby {
    ...
    public static class Resource {
        ...
        public DataResponse<E3> insertE3ReadConstrained(@Context UriInfo uriInfo, String requestBody) {
            Constraint<E3, Object> tc = Constraint.idOnly(E3.class).attribute(E3.NAME.getName());
        ...
        public SimpleResponse create_WriteConstrainedId(
            ...
            Constraint<E8, Object> tc = Constraint.idOnly(E8.class).attribute(E8.NAME.getName());
        ...
        public DataResponse<E8> create_WriteConstrainedIdBlocked(
                ...
                @Context UriInfo uriInfo,
                String requestBody) {
            Constraint<E8, Object> tc = Constraint.excludeAll(E8.class).attribute(E8.NAME.getName());
