...
public class EntityOverlay_PerStackIT extends MainDbTest {

    @BQTestTool
    static final MainModelTester tester = tester(Resource.class)
            .entities(E22.class, E25.class, E2.class, E3.class)
            .agCustomizer(EntityOverlay_PerStackIT::addOverlay)
            .build();
    ...
    private static AgRuntimeBuilder addOverlay(AgRuntimeBuilder builder) {
        ...
        AgEntityOverlay<E22> e22Overlay = AgEntity
                .overlay(E22.class)
                .toOne("overlayToOne", E25.class, EntityOverlay_PerStackIT::findForParent);
