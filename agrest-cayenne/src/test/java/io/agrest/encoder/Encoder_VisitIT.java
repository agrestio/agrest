...
public class Encoder_VisitIT extends EncoderITBase {
	...
	public void testVisit_StartLimit() {
		...
		EncoderITBase.DB.insert("e2", "id, name", "2, 'yyy'");
		EncoderITBase.DB.insert("e2", "id, name", "3, 'zzz'");
		EncoderITBase.DB.insert("e2", "id, name", "4, 'zzz'");
	...
	public void testVisit_Related() {
		...
		EncoderITBase.DB.insert("e3", "id, e2_id, name", "7, 2, 'zzz'");
		EncoderITBase.DB.insert("e3", "id, e2_id, name", "8, 1, 'yyy'");
		EncoderITBase.DB.insert("e3", "id, e2_id, name", "9, 1, 'zzz'");
