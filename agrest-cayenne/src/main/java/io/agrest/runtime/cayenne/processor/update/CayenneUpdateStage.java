...
public class CayenneUpdateStage extends CayenneUpdateDataStoreStage {
    ...
    protected <T extends DataObject> void afterUpdatesMerge(UpdateContext<T, Expression> context, Map<Object, Collection<EntityUpdate<T>>> keyMap) {
        if (!keyMap.isEmpty()) {
    ...
    protected <T extends DataObject> Map<Object, Collection<EntityUpdate<T>>> mutableKeyMap(UpdateContext<T, Expression> context, ObjectMapper<T, Expression> mapper) {
    ...
    protected <T extends DataObject> ObjectMapper<T, Expression> createObjectMapper(UpdateContext<T, Expression> context) {
    ...
    <T extends DataObject> List<T> itemsForKeys(UpdateContext<T, Expression> context, Collection<Object> keys, ObjectMapper<T, Expression> mapper) {
