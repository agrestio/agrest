...
public class AttributeEncoderFactoryProvider implements Provider<IAttributeEncoderFactory> {
    ...
    protected Map<Class<?>, Encoder> appendKnownEncoders(Map<Class<?>, Encoder> encoders) {
        encoders.put(IAttributeEncoderFactory.LOCAL_DATE, ISOLocalDateEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.LOCAL_TIME, ISOLocalTimeEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.LOCAL_DATETIME, ISOLocalDateTimeEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.OFFSET_DATETIME, ISOOffsetDateTimeEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.UTIL_DATE, ISODateTimeEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.SQL_TIMESTAMP, ISODateTimeEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.SQL_DATE, ISODateEncoder.encoder());
        encoders.put(IAttributeEncoderFactory.SQL_TIME, ISOTimeEncoder.encoder());
