 ...
 * @since 5.0
 */
public class CayenneCreateProcessorFactoryProvider implements Provider<CreateProcessorFactory> {

    private final AgExceptionMappers exceptionMappers;
    private final EnumMap<UpdateStage, Processor<UpdateContext<?>>> stages;

    public CayenneCreateProcessorFactoryProvider(
        ...
        this.stages.put(UpdateStage.MAP_CHANGES, mapCreateStage);
        ...
        this.stages.put(UpdateStage.FILL_RESPONSE, createdResponseStage);
