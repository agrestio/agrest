 ...
 * @since 5.0
 */
public class CayenneIdempotentCreateOrUpdateProcessorFactoryProvider implements Provider<IdempotentCreateOrUpdateProcessorFactory> {

    private final AgExceptionMappers exceptionMappers;
    private final EnumMap<UpdateStage, Processor<UpdateContext<?>>> stages;

    public CayenneIdempotentCreateOrUpdateProcessorFactoryProvider(
        ...
        this.stages.put(UpdateStage.MAP_CHANGES, mapIdempotentCreateOrUpdateStage);
