...
import com.nhl.link.rest.runtime.processor.update.CreateResourceEntityStage;
...
public class CayenneUpdateProcessorFactoryFactoryProvider implements Provider<UpdateProcessorFactoryFactory> {
    ...
    public CayenneUpdateProcessorFactoryFactoryProvider(
        ...
        this.createStages.put(UpdateStage.CONSTRUCT_ENTITY, createResourceEntityStage);
        ...
        this.updateStages.put(UpdateStage.CONSTRUCT_ENTITY, createResourceEntityStage);
        ...
        this.createOrUpdateStages.put(UpdateStage.CONSTRUCT_ENTITY, createResourceEntityStage);
        ...
        this.idempotentCreateOrUpdateStages.put(UpdateStage.CONSTRUCT_ENTITY, createResourceEntityStage);
        ...
        this.idempotentFullSyncStages.put(UpdateStage.CONSTRUCT_ENTITY, createResourceEntityStage);
