...
public abstract class BaseRequestProcessor {
	...
	public static String string(Map<String, List<String>> parameters, Term name) {

		List<String> strings = strings(parameters, name);
		return strings.isEmpty() ? null : strings.get(0);
	}

    public static List<String> strings(Map<String, List<String>> parameters, Term name) {
		return strings(parameters, name.toString());
	}
    ...
    public static int integer(Map<String, List<String>> parameters, Term name) {
