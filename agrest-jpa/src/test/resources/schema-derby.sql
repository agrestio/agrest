...
CREATE TABLE e7 (e8_id INTEGER , id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, name VARCHAR (100), PRIMARY KEY (id))
;
...
CREATE TABLE e34 (id  BIGINT  NOT NULL , firstName VARCHAR (100), lastName VARCHAR (100), PRIMARY KEY (id))
;
