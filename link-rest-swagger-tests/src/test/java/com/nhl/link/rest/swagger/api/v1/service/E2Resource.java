...
public class E2Resource {
    ...
    public DataResponse<E2> create(String e2, @QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes, @QueryParam("exclude") List<com.nhl.link.rest.protocol.Exclude> excludes) {
        ...
        return LinkRest.create(E2.class, config)
                    .readConstraint(Constraint.excludeAll(E2.class).includeId().attributes("name", "address")
                        .path("e3s",Constraint.excludeAll(E3.class).includeId().attributes("name", "phoneNumber")
    ...
    public DataResponse<E2> getAll(@QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes, @QueryParam("exclude") List<com.nhl.link.rest.protocol.Exclude> excludes, @QueryParam("cayenneExp") CayenneExp cayenneExp) {
    ...
    @Path("/v1/e2/{id}/e3s/{tid}")
    @Produces({ "application/json" })
        public DataResponse<E3> getE3viaE2(@PathParam("id") Integer id, @PathParam("tid") Integer tid, @QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes) {
    ...
    @Path("/v1/e2/{id}")
    @Produces({ "application/json" })
        public DataResponse<E2> getOne(@PathParam("id") Integer id, @QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes, @QueryParam("exclude") List<com.nhl.link.rest.protocol.Exclude> excludes) {
    ...
    @Path("/v1/e2/{id}/e3s")
    @Produces({ "application/json" })
        public DataResponse<E3> getOneToMany(@PathParam("id") Integer id, @QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes) {
    ...
    @Path("/v1/e2/{id}")
    @Consumes({ "application/json" })
    public DataResponse<E2> update(@PathParam("id") Integer id, String e2, @QueryParam("include") List<com.nhl.link.rest.protocol.Include> includes, @QueryParam("exclude") List<com.nhl.link.rest.protocol.Exclude> excludes) {
