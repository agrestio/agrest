...
public class PUT_Related_ByKey_IT extends JerseyTestOnDerby {
	...
	public void testRelate_ToMany_MixedCollection() {
		...
		context.performGenericQuery(
				new SQLTemplate(E3.class, "INSERT INTO utest.e7 (id, name, e8_id) values (7, 'zzz', 16)"));
		context.performGenericQuery(
				new SQLTemplate(E3.class, "INSERT INTO utest.e7 (id, name, e8_id) values (8, 'yyy', 15)"));
		context.performGenericQuery(
				new SQLTemplate(E3.class, "INSERT INTO utest.e7 (id, name, e8_id) values (9, 'aaa', 15)"));
		...
		int id = SQLSelect.scalarQuery(Integer.class, "SELECT id FROM utest.e7 WHERE name = 'newname'")
				.selectOne(context);
	...
	public void testPUT_ToMany_LongId() throws WebApplicationException, IOException {
		...
		assertEquals("{\"data\":[{\"id\":4,\"name\":\"zzz\"},{\"id\":11,\"name\":\"new\"}],\"total\":2}",
				r1.readEntity(String.class));
