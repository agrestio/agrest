...
public class E4Resource {
    ...
    public DataResponse<E4> getAll(@QueryParam("limit") Limit limit, @QueryParam("sort") Sort sort, @QueryParam("include") List<Include> includes, @QueryParam("mapBy") MapBy mapBy) {
    ...
    @Path("/v1/e4/{id}")
    @Produces({ "application/json" })
        public DataResponse<E4> getOne(@PathParam("id") Integer id, @QueryParam("include") List<Include> includes) {
