...
public class E3Resource {
    ...
    public DataResponse<E3> create(String e3, @QueryParam("include") List<Include> includes, @QueryParam("exclude") List<Exclude> excludes) {
    ...
    public DataResponse<E3> getAll(@QueryParam("sort") Sort sort, @QueryParam("include") List<Include> includes, @QueryParam("exclude") List<Exclude> excludes, @QueryParam("limit") Limit limit, @QueryParam("start") Start start, @QueryParam("mapBy") MapBy mapBy, @QueryParam("cayenneExp") CayenneExp cayenneExp) {
    ...
    @Path("/v1/e3/{id}")
    @Produces({ "application/json" })
        public DataResponse<E3> getOne(@PathParam("id") Integer id, @QueryParam("include") List<Include> includes) {
    ...
    @Path("/v1/e3/{id}/e2")
    @Produces({ "application/json" })
        public DataResponse<E2> getOneByOne(@PathParam("id") Integer id, @QueryParam("include") List<Include> includes) {
    ...
    @Path("/v1/e3")
    @Consumes({ "application/json" })
    public DataResponse<E3> updateAll(String e3, @QueryParam("include") List<Include> includes, @QueryParam("exclude") List<Exclude> excludes) {
