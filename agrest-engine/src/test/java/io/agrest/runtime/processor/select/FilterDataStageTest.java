...
public class FilterDataStageTest {

    @Test
    public void testFilterList_AllMatches() {
        List<Object> unfiltered = asList("a", "b", "c");
        List<Object> filtered = FilterDataStage.filterList(unfiltered, o -> true);
    ...
    public void testFilterList_MatchStart() {
        ...
        List<String> filtered = FilterDataStage.filterList(unfiltered, o -> o.startsWith("a"));
    ...
    public void testFilterList_MatchMiddle() {
        ...
        List<String> filtered = FilterDataStage.filterList(unfiltered, o -> o.startsWith("b"));
    ...
    public void testFilterList_MatchEnd() {
        List<String> unfiltered = asList("a", "b", "ac", "bb");
        List<String> filtered = FilterDataStage.filterList(unfiltered, o -> o.equals("bb"));
    ...
    public void testFilterList_NoMatches() {
        List<String> unfiltered = asList("a", "b", "ac", "bb");
        List<String> filtered = FilterDataStage.filterList(unfiltered, o -> false);
