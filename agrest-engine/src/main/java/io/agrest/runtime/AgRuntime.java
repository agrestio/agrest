...
public class AgRuntime {
    ...
    public <T> SelectBuilder<T> select(Class<T> type) {
        SelectContext<T> context = new SelectContext<>(type, new RequestSchema(schema), request(), pathChecker, injector);
    ...
    public <T> UpdateBuilder<T> create(Class<T> type) {
        UpdateContext<T> context = new UpdateContext<>(type, new RequestSchema(schema), request(), pathChecker, injector);
    ...
    public <T> UpdateBuilder<T> idempotentCreateOrUpdate(Class<T> type) {
        UpdateContext<T> context = new UpdateContext<>(type, new RequestSchema(schema), requestBuilderFactory.builder(), pathChecker, injector);
