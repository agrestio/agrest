...
public class UpdateProcessorFactoryProvider implements Provider<UpdateProcessorFactory> {
    ...
    public UpdateProcessorFactoryProvider(
            ...
            @Inject(UpdateFlavorDIKeys.UPDATE) UpdateMapChangesStage mapChangesStage,
            ...
            @Inject(UpdateFlavorDIKeys.UPDATE) UpdateFillResponseStage fillResponseStage,
