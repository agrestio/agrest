 ...
 * @since 3.4
 */
public abstract class NestedEntityResultReader<T extends NestedResourceEntity<?>> implements PropertyReader {
    ...
    public NestedEntityResultReader(T entity, PropertyReader parentKeyReader) {
