...
public interface Encoder {
     ...
     * @param skipNullProperties whether to skip properties with null values
     * @param out                output object where encoded JSON should be written.
     */
    void encode(String propertyName, Object object, boolean skipNullProperties, JsonGenerator out) throws IOException;
}
