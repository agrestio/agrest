...
public class POST_Related_IT extends JerseyTestOnDerby {
    ...
    public static class Resource {
        ...
        public DataResponse<E3> createOrUpdateE3sOfE2(@PathParam("id") int id, String targetData) {
            return Ag.createOrUpdate(E3.class, config).toManyParent(E2.class, id, E2.E3S.getName()).syncAndSelect(targetData);
        }

        @POST
        @Path("e12/{id}/e1213")
        public DataResponse<E12E13> create_Joins(@PathParam("id") int id, @Context UriInfo info, String entityData) {
            return Ag.create(E12E13.class, config).toManyParent(E12.class, id, E12.E1213.getName()).uri(info)
        ...
        public DataResponse<E18> createOrUpdateE18s(
            ...
            return Ag.createOrUpdate(E18.class, config).toManyParent(E17.class, parentIds, E17.E18S.getName()).uri(uriInfo)
